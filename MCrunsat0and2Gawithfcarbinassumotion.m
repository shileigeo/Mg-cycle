...
% %绘制pcolor图
% figure(1)
% pcolor(Xedgemesh,Yedgemesh,N');
% % shading interp; 
% xlim([0 1]);ylim([0 1]);
% hold on; plot(mfcarbinsolved,mfcarboutsolved,'o');plot(mfcarbinsolved1,mfcarboutsolved1,'o');
% %根据pcolor图的颜色绘制散点图颜色
